...
import { type SkillDieType, type SkillDieValue } from '@/stores/dicePool'
...
<template>
  <svg class="SkillDie" :width="size" :height="size" viewBox="0 0 100 100">
    ...
    <polygon
      v-if="rollValue === 3"
      points="50,33 32.68,63 67.32,63"
      stroke-width="6"
      stroke="white"
    ...
    <polygon
      v-if="rollValue === 5"
      points="50,30 61.76,66.18 30.98,43.82 69.02,43.82 38.24,66.18"
      stroke-width="6"
      stroke="white"
      stroke-linejoin="round"
      fill="white"
